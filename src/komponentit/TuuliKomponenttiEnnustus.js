...
{ console.log("cell " + cell + " length " + cell.length) }
                      ...
                      (cell.substring(6,10)==='0.09')) ? <i className="bi bi-cloud-fog-fill haaleanharmaa" title={cell} ></i>:""}
                      ...
                      (cell.substring(6,8)==='19.')) ? <i className="bi bi-cloud-rain-heavy-fill haaleanharmaa" title={cell}></i>:""}                               

                      {/* sadeton pilvi*/}
                      {index===2 && (cell.endsWith("NaN") || (cell.substring(6,9)==='0.0' && cell.length === 9)) ? <i className="bi bi-cloud-check-fill haaleanharmaa" title={cell}></i>:""}  
